...
- **Access Control**: Admin parameters restricted to the owner; `closeDelivery` callable by either position participant or the validator; liquidations are permissionless
