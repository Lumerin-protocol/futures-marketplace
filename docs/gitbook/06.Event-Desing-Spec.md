...
This document is the single source of truth for `HashPowerFutures.sol` **3.x** events, their
...
Trigger: optional permissionless maintenance via `removeOutdatedOrders([orderId, ...])`.
