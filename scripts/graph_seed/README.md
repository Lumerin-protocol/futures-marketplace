# Graph Seed Script - Futures Marketplace

This script deploys the Futures Marketplace subgraph to The Graph Studio from your local machine.
...
```bash
# Deploy to dev environment (auto-generates version from git tags)
./deploy.sh dev
...
The script auto-generates versions using the same logic as CI/CD:
- Reads last `subgraph-v*` tag from git
- Increments patch version
- Appends environment suffix (e.g., `v2.0.3-dev`)

To override, pass version as second argument: `./deploy.sh dev v1.0.0`
